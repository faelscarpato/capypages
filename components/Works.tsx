      ...
      <div className="max-w-[1440px] mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 auto-rows-[350px] grid-flow-dense">
        {projects.map((project, idx) => (
          <motion.div 
            ...
            className={`group relative rounded-3xl overflow-hidden glass-card cursor-pointer border-white/5 hover:border-primary/40 transition-all duration-500 shadow-xl hover:shadow-primary/5 ${project.size}`}
          >
        ...
        <motion.div 
          ...
          className="group relative rounded-3xl overflow-hidden glass-card flex flex-col items-center justify-center p-12 text-center border-dashed border-2 border-white/10 hover:border-primary/50 transition-all active:scale-95"
        >
